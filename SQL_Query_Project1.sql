...
-- Q3 Provide category name?
SELECT DISTINCT Category as Category_name FROM retail_sales;

-- Finding business key problems & answer with Data Analysis 

-- Q1. Write a SQL query to retrive all column for sales mode on '2022-11-05'.
SELECT * FROM retail_sales
...
-- Q6. Write a SQL query to find the total number of (transaction_id) made by each gender in each.
SELECT 
      Category, 
	  Gender, 
...
-- Q9. Write a SQL query to find the total number of unique customers who purchased items from each category.
